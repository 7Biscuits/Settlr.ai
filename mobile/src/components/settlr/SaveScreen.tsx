...
import { SaveIllustration } from './illustrations/SaveIllustration';
...
const INITIAL_POTS: PotItem[] = [
  {
    id: '1',
    title: 'Emergency Group Fund',
    amount: '+$850.00',
    isPositive: true,
  ...
  {
    id: '2',
    title: 'Goa Villa Security Deposit',
    amount: '+$420.00',
    isPositive: true,
    icon: <MoneyBagIcon />,
  },
  {
    id: '3',
    title: 'Flatmate Maintenance Pot',
    amount: '+$150.50',
    isPositive: true,
...
const EXTRA_POTS: PotItem[] = [
  {
    id: '4',
    title: 'Weekend Barbecue Pool',
    amount: '+$90.00',
    isPositive: true,
    icon: <MoneyBagIcon />,
  },
...
export function SaveScreen({
  ...
  const pots = expanded ? [...INITIAL_POTS, ...EXTRA_POTS] : INITIAL_POTS;
  const intPart = Math.floor(savedAmount);
  const decPart = (savedAmount % 1).toFixed(2).substring(1);
      ...
      <ScrollView
        ...
        <View style={[styles.topSection, { paddingTop: topInset + 4 }]}>
          ...
          <View style={styles.headerRow}>
            ...
            <Text style={styles.headerTitle}>SETTLR VAULT</Text>
            <Pressable
              hitSlop={14}
          ...
          {/* Date Subtitle */}
          <Text style={styles.dateSubtitle}>March 1 - March 31 • Group Savings</Text>
          ...
          {/* Days Left Label */}
          <Text style={styles.daysLeftText}>71% of savings goal reached</Text>
          ...
          <View style={styles.visualWrapper}>
            ...
            <SaveIllustration savedAmount={savedAmount} targetAmount={targetAmount} />
          </View>
        </View>
        ...
        <View style={styles.bottomCard}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statColumn}>
              ...
              <View style={styles.statSubRow}>
                <Text style={styles.statSubTextMuted}>until </Text>
                <Text style={styles.statSubTextBlue}>${targetAmount.toLocaleString()}</Text>
            ...
            {/* Right Metric: Daily Rate */}
            <View style={styles.statColumn}>
              <View style={styles.amountRow}>
                <Text style={styles.currencySymbol}>$</Text>
                <Text style={styles.statInteger}>47</Text>
                <Text style={styles.statDecimal}>.35</Text>
              </View>
              <Text style={styles.statSubTextMuted}>daily growth</Text>
            </View>
          </View>
          ...
          {showInsightBanner && (
            <View style={styles.insightBanner}>
              ...
              <Text style={styles.insightText}>
                Group vault is $340 ahead of target. Slaying the trip prep 🔥
              </Text>
              <Pressable
                hitSlop={8}
          ...
          <View style={styles.sectionHeaderWrapper}>
            <Pressable
              ...
              <Text style={styles.sectionTitle}>GROUP POTS</Text>
          ...
          <View style={styles.potsList}>
            {pots.map((item) => (
              <View key={item.id} style={styles.potRow}>
