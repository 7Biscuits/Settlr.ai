...
- To add or invite someone to a group, first identify the group with get_groups and obtain the person's email from the user. Then use invite_to_group. It adds existing PayPilot users immediately; for a new user it returns an invitation deep link that the mobile app can send to the selected contact.
