...
import { BorrowIllustration } from './illustrations/BorrowIllustration';
...
const INITIAL_TRANSFERS: TransferItem[] = [
  {
    id: '1',
    title: 'Spot Me Instant Transfer',
    amount: '+$250.00',
    isPositive: true,
...
const EXTRA_TRANSFERS: TransferItem[] = [
  {
    id: '4',
    title: 'Grocery Settlement Buffer',
    amount: '+$80.00',
    isPositive: true,
    icon: <MoneyBagIcon />,
  },
...
export function BorrowScreen({ onOpenSettings, onSendTransfer }: BorrowScreenProps) {
  ...
  const transfers = expanded
    ? [...INITIAL_TRANSFERS, ...EXTRA_TRANSFERS]
    : INITIAL_TRANSFERS;
      ...
      <ScrollView
        ...
        <View style={[styles.topSection, { paddingTop: topInset + 4 }]}>
          ...
          <View style={styles.headerRow}>
            ...
            <Text style={styles.headerTitle}>DIRECT TRANSFERS</Text>
            <Pressable
              hitSlop={14}
          ...
          {/* Date Subtitle */}
          <Text style={styles.dateSubtitle}>Zero-Fee Peer-to-Peer Settlement</Text>
          ...
          {/* Days Left Label */}
          <Text style={styles.daysLeftText}>Instant free settlement active</Text>
        ...
        <View style={styles.bottomCard}>
          ...
          <View style={styles.statsRow}>
            ...
            <View style={styles.statColumn}>
              ...
              <View style={styles.statSubRow}>
                <Text style={styles.statSubTextMuted}>available </Text>
                <Text style={styles.statSubTextBlue}>advance</Text>
            ...
            {/* Right Metric: Zero APR / Fee */}
            <View style={styles.statColumn}>
              <View style={styles.amountRow}>
                <Text style={styles.currencySymbol}>$</Text>
                <Text style={styles.statInteger}>0</Text>
                <Text style={styles.statDecimal}>.00</Text>
              </View>
              <Text style={styles.statSubTextMuted}>transfer fee</Text>
            </View>
          </View>
          ...
          {showInsightBanner && (
            <View style={styles.insightBanner}>
              ...
              <Text style={styles.insightText}>
                No interest. 0% transfer fees. Settle debts with anyone instantly ✨
              </Text>
              <Pressable
                hitSlop={8}
          ...
          <View style={styles.sectionHeaderWrapper}>
            <Pressable
              ...
              <Text style={styles.sectionTitle}>TRANSFERS & ADVANCES</Text>
          ...
          <View style={styles.advancesList}>
            {transfers.map((item) => (
              <View key={item.id} style={styles.advanceRow}>
                <View style={styles.advanceLeft}>
                  {item.icon}
                  <Text style={styles.advanceName} numberOfLines={1}>
                    {item.title}
                  </Text>
                </View>
